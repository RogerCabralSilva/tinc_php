        ...
        <table class="table table-hover table-condensed tb-opacidade bg-warning">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="usuarios_atualiza.php?id=<?php echo $row['id'] ?>" role="button"
                            class="btn btn-warning btn-block btn-xs">
                            <span class="glyphicon glyphicon-refresh"></span>
                            <span class="hidden-xs">ALTERAR</span>
                        </a>

                        <button data-nome="<?php echo $row['login'];?>" data-id="<?php echo $row['id'];?>"
...
$('.delete').on('click', function() {
    ...
    $('a.delete-yes').attr('href', 'usuarios_delete.php?id=' + id); //chama o arquivo php para excluir o produto
