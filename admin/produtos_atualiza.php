...
if ($_POST) 
{
    ...
    {
        unlink("../images/".$_POST['imagem_atual']); // apaga do servidor de arquivo :)
        $nome_img = $_FILES['imagemfile']['name'];
        $tmp_img = $_FILES['imagemfile']['tmp_name'];
        $rand = mt_rand(100001, 999999); // gera um número aleátorio
    ...
    $update = "UPDATE produtos SET tipo_id = $id_tipo, destaque = '$destaque', descricao = '$descricao', resumo = '$resumo', valor = $valor, imagem = '$nome_img'
                WHERE id = $id ";
                ...
                <div class="thumbnail">
                    <div class="alert alert-danger" role="alert">
                        <form action="produtos_atualiza.php" method="post" name="form_insere"
                            ...
                            <!-- Campo id deve permancer oculto "hidden" -->
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="descricao" id="descricao" class="form-control"
                                    placeholder="Digite a descrição do Produto" maxlength="100" value="<?php echo $row['descricao'] ?>">
                            </div>
