    ...
    <div class="container">
        <h2 class="breadcrumb alert-danger">
            <a href="index.php">
                ...
                <!-- use a tag ROGER -->
                <strong>Detalhes do Produtos</strong>
            </a>
        </h2>
        <div class="row">
            <?php do{?>
                ...
                <div class="thumbnail">
                    <a href="">
                        <img src="images/<?php echo $linhaDestaque['imagem']; ?>"
                            alt="<?php echo $linhaDestaques['descricao']; ?>" class="img-responsive img-rounded"
                            style="height:20em;">
                    </a>
                    <div class="caption text-center">
                        <h3 class="text-danger">
                            <strong>
                                <?php echo $linhaDestaque['descricao']?>
                            </strong>
                        </h3>
                        <p class="text-warning">
                            <strong>
                                <?php echo $linhaDestaque['rotulo']?>
                            </strong>
                        </p>
                        <p class="text-center">
                            <strong>
                                <?php echo $linhaDestaque['resumo']?>
                            </strong>
                        </p>
                        <p>
